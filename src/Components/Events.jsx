...
const events = [
  ...
  },
  {
    ...
    description: "A hands-on workshop where participants design and build drones and robotics, applying creativity and problem-solving to real-world challenges.",
  },
  {
    id: 5,
...
function Events() {
  return (
    <div className="w-full min-h-screen bg-black text-white flex flex-col items-center py-10 justify-center relative overflow-hidden bg-gradient-to-b from-black via-purple-950 to-black">
      <h1 className="text-4xl sm:text-5xl font-bold mb-10 py-10 text-center text-purple-500">
