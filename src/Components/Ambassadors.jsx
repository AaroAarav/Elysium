...
function Ambassadors() {
  return (
    <div className="w-full min-h-screen font-kek bg-gradient-to-b from-black via-purple-950 to-black text-white flex flex-col items-center justify-center px-6 py-12 pt-30 sm:pt-20">
      ...
      >
        Join us as a{" "}
        <span className="text-pink-400 font-semibold">Community Partner</span>{" "}
        at
        <span className="text-purple-400 font-semibold"> Elysium 2025</span>,
        organized by IEEE WIE, Manipal University Jaipur. Gain{" "}
        <span className="font-bold">
          recognition, exclusive access, and networking opportunities
        </span>{" "}
        at one of India’s largest tech events.
        <div className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-6 text-center max-w-3xl">
          <div className="bg-white/10 p-4 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Your logo on our platforms & event promotions.
            </p>
          </div>
          <div className="bg-white/10 p-4 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Connect with students, professionals & industry leaders.
            </p>
          </div>
          <div className="bg-white/10 p-4 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Showcase your community to 25,000+ attendees.
            </p>
          </div>
          <div className="bg-white/10 p-4 rounded-lg">
            ...
            <p className="text-gray-400 text-sm">
              Attend workshops, competitions & speaker sessions.
            </p>
          </div>
        </div>
