...
function KeyStats() {
  return (
    <div className="w-full font-kek min-h-screen bg-black bg-gradient-to-b from-black via-purple-950 to-black text-white flex items-center justify-center relative overflow-hidden px-6 py-12 pt-30 pb-20 sm:pb-20 sm:pt-10">
